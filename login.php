...
<body class="text-center">
  ...
  <form class="form-signin" id="login-form" method="post" target="_self">
    <lord-icon src="https://cdn.lordicon.com/dxjqoygy.json" trigger="loop" colors="primary:#121331,secondary:#08a88a" style="width:250px;height:250px">
    </lord-icon>
